"""Envoltorio: la logica vive en `horizun_pbi_mcp.completado.libs`.
...
recomienda tiene que existir en la misma instalacion que da el diagnostico.
    ...
    python scripts/fetch_libs.py [...]     # equivale a:
...
from horizun_pbi_mcp.completado.libs import main  # noqa: E402
