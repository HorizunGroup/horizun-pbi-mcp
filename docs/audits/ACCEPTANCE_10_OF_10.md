...
| | Gates |
|---|---|
| Cumplidos con evidencia | **34** (G1.1, G1.2, G1.3, G1.4, G1.5, G1.6, G1.7, G1.8, G2.1, G2.2, G2.3, G2.4, G2.5, G3.6, G4.2, G4.3, G4.4, G4.5, G4.6, G4.8, G4.9, G4.10, G5.5, G6.3, G6.5, G7.6, G8.1, G8.2, G8.3, G8.4, G8.5, G8.6, G8.7, G8.8) |
...
| G4.6 | `tests/test_lock_de_dependencias.py`, atado a los **classifiers**: las cinco versiones de Python declaradas tienen lock, y la única plataforma declarada es Windows | ✅ **2026-08-15** — el hueco real no era el runner Linux: eran 3.11 y 3.12, prometidas y sin lock |
