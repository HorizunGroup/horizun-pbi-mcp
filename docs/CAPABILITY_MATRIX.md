...
|---|---|---|---|
| **Horizun PBI MCP** (this repo) | 1.5.4 | Present, starts | **Tested** — stdio handshake, 134 tools, live DAX, PBIR fixture, verified Excel/PDF exports, Desktop capture by PID and simulated Graph folder traversal/download |
