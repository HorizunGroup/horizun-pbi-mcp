...
|---|---|---|---|
| **Horizun PBI MCP** (este repo) | 1.0.0-rc.11 | Presente, arranca | **Probada** — handshake stdio, 117 tools, más de 1500 pruebas, DAX en vivo, fixture PBIR y captura de Desktop por PID |
