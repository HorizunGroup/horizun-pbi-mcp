...
faltan esperan un entorno. Y esa lista se encogió dos veces el mismo día, las dos
por mirar dentro en vez de dar el bloque por imposible: **G4.3** solo necesitaba
Node ≥20 —no una VM— y **G4.6** pedía un runner Linux para un producto que declara
Windows y nada más.
