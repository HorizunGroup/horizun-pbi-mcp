...
|---|---|---|---|---|
| CORE-001 | Detección falsa de proyecto cerrado (`project_state` ignora el título de ventana que `desktop_launcher` sí usa) | Crítica | G1.1 | **Abierta** |
...
29 entradas: 1 cerrada (CONTRACT-001), 6 parcialmente cerradas, 22 abiertas.
