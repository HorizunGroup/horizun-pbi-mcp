...
|---|---|
| Tools | **139** |
| Ejecutadas por MCP en cada corrida | **139** |
| Con caso negativo que las hace fallar | **131** |
...
| `pbi_apply_audit_fixes` | destructiva | 3 | 1 | sí | sí | falta un requerido | `actions` |
| `pbi_apply_design_system` | escritura | 2 | 1 | — | sí | falta un requerido | `system` |
| `pbi_apply_page_spec` | escritura | 6 | 1 | — | sí | falta un requerido | `spec` |
| `pbi_apply_plan` | destructiva | 4 | 1 | sí | sí | falta un requerido | `plan_token` |
| `pbi_apply_theme` | escritura | 7 | 0 | — | sí | tipo invalido | `preset` |
| `pbi_arrange_visuals` | escritura | 7 | 1 | — | sí | falta un requerido | `page` |
| `pbi_audit_model` | solo lectura | 3 | 0 | — | sí | tipo invalido | `source` |
| `pbi_audit_project` | escritura | 4 | 0 | — | sí | tipo invalido | `rules` |
| `pbi_audit_report_only` | solo lectura | 0 | 0 | — | sí | sin proyecto activo | — |
| `pbi_backup_pbip_project` | escritura | 3 | 0 | — | sí | tipo invalido | `mode` |
| `pbi_build_dashboard` | escritura | 7 | 2 | — | sí | falta un requerido | `measures, name` |
| `pbi_build_evm_page` | escritura | 6 | 1 | — | sí | falta un requerido | `measures` |
...
| `pbi_convert_pbix_to_pbip` | escritura | 10 | 2 | — | sí | falta un requerido | `out_dir, path` |
| `pbi_copy_visual_format` | escritura | 5 | 4 | — | sí | falta un requerido | `source_page, source_visual, target_page, target_visuals` |
| `pbi_create_bookmark` | escritura | 9 | 2 | — | sí | falta un requerido | `display_name, page` |
| `pbi_create_calculated_column` | escritura | 11 | 3 | — | sí | falta un requerido | `expression, name, table` |
| `pbi_create_calculated_table` | escritura | 6 | 2 | — | sí | falta un requerido | `expression, name` |
| `pbi_create_hierarchy` | escritura | 7 | 3 | — | sí | falta un requerido | `levels, name, table` |
| `pbi_create_html_visual` | escritura | 5 | 3 | — | sí | falta un requerido | `html_measure, page, position` |
| `pbi_create_measure` | escritura | 10 | 3 | — | sí | falta un requerido | `expression, name, table` |
| `pbi_create_page_from_spec` | escritura | 2 | 1 | — | sí | falta un requerido | `spec` |
| `pbi_create_pbip_project` | escritura | 9 | 2 | — | sí | falta un requerido | `name, out_dir` |
| `pbi_create_relationship` | escritura | 11 | 4 | — | sí | falta un requerido | `from_column, from_table, to_column, to_table` |
| `pbi_create_visual` | escritura | 7 | 4 | — | sí | falta un requerido | `fields, page, position, visual_type` |
| `pbi_define_brief` | escritura | 9 | 2 | — | sí | falta un requerido | `audience, purpose` |
| `pbi_define_port_contract` | escritura | 3 | 1 | — | sí | falta un requerido | `datasets` |
| `pbi_delete_bookmark` | destructiva | 3 | 1 | sí | sí | falta un requerido | `name` |
| `pbi_delete_measure` | destructiva | 5 | 2 | sí | sí | falta un requerido | `name, table` |
| `pbi_delete_page` | destructiva | 3 | 1 | sí | sí | falta un requerido | `page` |
| `pbi_delete_visual` | destructiva | 4 | 2 | sí | sí | falta un requerido | `page, visual_id` |
| `pbi_detect_layout_issues` | solo lectura | 1 | 0 | — | sí | tipo invalido | `page` |
| `pbi_diagnose_data` | solo lectura | 2 | 0 | — | sí | tipo invalido | `tables` |
| `pbi_diff_page_spec` | solo lectura | 2 | 1 | — | sí | falta un requerido | `spec` |
| `pbi_disable_auto_date_time` | escritura | 2 | 0 | — | sí | tipo invalido | `enabled` |
| `pbi_distribute_visuals` | escritura | 4 | 2 | — | sí | falta un requerido | `page, visual_ids` |
| `pbi_document_model` | escritura | 2 | 0 | — | sí | tipo invalido | `source` |
| `pbi_document_report_layout` | escritura | 0 | 0 | — | sí | sin proyecto activo | — |
| `pbi_duplicate_page` | escritura | 3 | 2 | — | sí | falta un requerido | `new_name, page` |
...
| `pbi_inspect_journal` | solo lectura | 1 | 1 | — | sí | falta un requerido | `journal` |
| `pbi_inspect_pbix` | solo lectura | 1 | 1 | — | sí | falta un requerido | `path` |
| `pbi_list_audit_rules` | solo lectura | 0 | 0 | — | sí | sin modo de fallo | — |
| `pbi_list_autofix_rules` | solo lectura | 0 | 0 | — | sí | sin modo de fallo | — |
| `pbi_list_bookmarks` | solo lectura | 0 | 0 | — | sí | sin proyecto activo | — |
| `pbi_list_convertible_pbix` | solo lectura | 2 | 1 | — | sí | falta un requerido | `path` |
| `pbi_list_design_systems` | solo lectura | 1 | 0 | — | sí | tipo invalido | `request_id` |
| `pbi_list_desktop_models` | solo lectura | 0 | 0 | — | sí | adaptador roto | — |
| `pbi_list_hierarchies` | solo lectura | 1 | 0 | — | sí | tipo invalido | `source` |
| `pbi_list_measures` | solo lectura | 3 | 0 | — | sí | tipo invalido | `source` |
| `pbi_list_page_presets` | solo lectura | 0 | 0 | — | sí | sin modo de fallo | — |
| `pbi_list_partitions` | solo lectura | 1 | 0 | — | sí | tipo invalido | `source` |
| `pbi_list_pending_journals` | solo lectura | 1 | 0 | — | sí | tipo invalido | `only_pending` |
| `pbi_list_perspectives` | solo lectura | 1 | 0 | — | sí | tipo invalido | `source` |
| `pbi_list_relationships` | solo lectura | 1 | 0 | — | sí | tipo invalido | `source` |
| `pbi_list_report_pages` | solo lectura | 0 | 0 | — | sí | sin proyecto activo | — |
| `pbi_list_report_resources` | solo lectura | 0 | 0 | — | sí | sin proyecto activo | — |
| `pbi_list_roles` | solo lectura | 1 | 0 | — | sí | tipo invalido | `source` |
| `pbi_list_tables` | solo lectura | 3 | 0 | — | sí | tipo invalido | `source` |
| `pbi_list_themes` | solo lectura | 0 | 0 | — | sí | sin modo de fallo | — |
| `pbi_list_visuals` | solo lectura | 1 | 1 | — | sí | falta un requerido | `page` |
| `pbi_measure_dependencies` | solo lectura | 3 | 1 | — | sí | falta un requerido | `name` |
...
| `pbi_prepare_delivery` | escritura | 2 | 0 | — | sí | tipo invalido | `dry_run` |
| `pbi_prepare_project` | escritura | 6 | 1 | — | sí | falta un requerido | `path` |
| `pbi_preview_page_spec` | escritura | 2 | 1 | — | sí | falta un requerido | `spec` |
| `pbi_preview_spec_html` | escritura | 1 | 1 | — | sí | falta un requerido | `spec` |
| `pbi_profile_data` | escritura | 2 | 0 | — | sí | tipo invalido | `tables` |
| `pbi_propose_dashboard` | solo lectura | 0 | 0 | — | sí | sin modo de fallo | — |
...
| `pbi_repair_broken_references` | escritura | 3 | 0 | — | sí | tipo invalido | `mapping` |
| `pbi_replace_visual_field` | escritura | 5 | 4 | — | sí | falta un requerido | `new_ref, old_ref, page, visual_id` |
...
| `pbi_set_conditional_format` | escritura | 13 | 5 | — | sí | falta un requerido | `field, max_color, min_color, page, visual_id` |
| `pbi_set_relationship_direction` | escritura | 5 | 2 | — | sí | falta un requerido | `from_table, to_table` |
| `pbi_set_storage_mode` | escritura | 3 | 2 | — | sí | falta un requerido | `mode, table` |
| `pbi_set_visual_filter` | escritura | 5 | 3 | — | sí | falta un requerido | `filters, page, visual_id` |
| `pbi_set_visual_title` | escritura | 5 | 2 | — | sí | falta un requerido | `page, visual_id` |
| `pbi_set_visual_z_order` | escritura | 3 | 2 | — | sí | falta un requerido | `order, page` |
| `pbi_sharepoint_download_folder` | escritura | 7 | 1 | — | sí | falta un requerido | `site_url` |
| `pbi_sharepoint_list_folder` | solo lectura | 5 | 1 | — | sí | falta un requerido | `site_url` |
| `pbi_start_here` | solo lectura | 1 | 0 | — | sí | tipo invalido | `request_id` |
| `pbi_test_connection` | solo lectura | 0 | 0 | — | sí | sin proyecto activo | — |
...
| `pbi_validate_pbip_project` | solo lectura | 0 | 0 | — | sí | sin proyecto activo | — |
| `pbi_validate_tmdl` | solo lectura | 2 | 0 | — | sí | tipo invalido | `path` |
