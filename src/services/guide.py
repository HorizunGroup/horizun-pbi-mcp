"""Por donde se empieza. Un punto de entrada para 112 tools.

El problema que cierra
----------------------
Ciento doce tools con buen nombre y buena descripcion siguen siendo ciento doce
tools. Quien llega no sabe si primero abre un proyecto o primero carga datos, ni
...
la tool y el motivo. Una lista de 112 opciones no es una respuesta a esa
pregunta; tres si.
