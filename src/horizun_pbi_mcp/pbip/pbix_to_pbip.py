...
from horizun_pbi_mcp.pbip import layout_to_pbir, pbix_reader
from horizun_pbi_mcp.pbip.pbix_reader import PbixContents
from horizun_pbi_mcp.powerbi.errors import PowerBIMCPError
from horizun_pbi_mcp.utils.file_utils import rutas_demasiado_largas
...
def convert(
    ...
    *,
    ...
    from horizun_pbi_mcp.services import project_publish
