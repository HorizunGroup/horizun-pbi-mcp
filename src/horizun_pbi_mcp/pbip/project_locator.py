...
from horizun_pbi_mcp.powerbi.errors import PathSecurityError, PbipNotFoundError, PbipStructureError
...
def validate_project(session: Session) -> Dict[str, Any]:
    ...
    if checks["has_tmdl"] and active.semantic_model_dir:
        from horizun_pbi_mcp.services import tmdl_validate  # perezoso: evita un ciclo de import
    ...
    if checks["has_tmdl"] and active.has_pbir and tmdl.get("valid"):
        from horizun_pbi_mcp.pbip import tmdl_reader  # perezoso: evita un ciclo de import
