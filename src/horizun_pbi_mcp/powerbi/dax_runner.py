...
from horizun_pbi_mcp.utils.validation import (validate_dax_query, validate_measure_expression,
...
def run_dax(session: Session, query: str, max_rows: Optional[int] = None,
    ...
    """
    from horizun_pbi_mcp.utils.validation import (MAX_BYTES_PERMITIDO, MAX_ROWS_PERMITIDO,
